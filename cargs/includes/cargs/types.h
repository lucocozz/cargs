...
typedef cargs_status_t (*cargs_handler_t)(cargs_t*, cargs_option_t*, char*);
typedef cargs_status_t (*cargs_free_handler_t)(cargs_option_t*);
typedef cargs_status_t (*cargs_validator_t)(value_t, validator_data_t);
