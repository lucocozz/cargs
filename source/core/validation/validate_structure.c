...
static cargs_error_t __ensure_validity(cargs_t *cargs, cargs_option_t *options,
...
static cargs_error_t __is_unique(cargs_t *cargs, cargs_option_t *option,
                                 cargs_option_t *other_option)
{
